    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="mb-8">
          ...
          <h1
            className="font-display text-3xl md:text-4xl font-bold text-foreground mt-3 mb-2"
            data-semtag-id="category.name"
            data-semtag-role="observable"
