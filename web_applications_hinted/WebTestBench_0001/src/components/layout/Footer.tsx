            ...
            <ul className="space-y-2">
              <li>
                <Link
                  ...
                  data-semtag-id="footer.category.tech"
                  data-semtag-role="navigation"
              ...
              <li>
                <Link
                  to="/category/home"
                  className="text-sm text-muted-foreground hover:text-primary transition-colors"
                  data-semtag-id="footer.category.home"
                  data-semtag-role="navigation"
                  data-semtag-target="category.home"
                >
                  Home Goods
                </Link>
              </li>
              <li>
                <Link
                  to="/category/fitness"
                  className="text-sm text-muted-foreground hover:text-primary transition-colors"
                  data-semtag-id="footer.category.fitness"
                  data-semtag-role="navigation"
                  data-semtag-target="category.fitness"
                >
                  Fitness
                </Link>
              </li>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/products"
                  className="text-sm text-muted-foreground hover:text-primary transition-colors"
                  data-semtag-id="footer.products"
                  data-semtag-role="navigation"
